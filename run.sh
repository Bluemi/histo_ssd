...
case "$1" in
	...
	d|default)
		...
		python3 ./utils/start_experiment.py -v $dry "./configs/base_config.yaml" p/augmentation/test_rotate_flip.yaml p/cluster/pepper.yaml p/dataset/lizard.yaml p/hparams/lr_narrow.yaml p/hparams/negative_ratio_narrow.yaml p/hparams/image_stride.yaml p/hparams/smoothl1.yaml p/hparams/nms_threshold.yaml p/metrics/map.yaml p/model/vgg16.yaml p/searcher/random.yaml
		;;
	o|orig)
